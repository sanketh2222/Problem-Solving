...
public enum PortfolioManagerFactory {
  ...
  //       ./gradlew test --tests PortfolioManagerFactory
   ...
   public static PortfolioManager getPortfolioManager(String provider,
     RestTemplate restTemplate) {
      ...
      StockQuotesService quotesService = StockQuoteServiceFactory.getService(provider, restTemplate);
      return new PortfolioManagerImpl(quotesService);
